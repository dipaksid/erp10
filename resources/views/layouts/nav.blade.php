...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseMaintenance" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                @can('STAFF LIST') <a class="collapse-item" href="{{ route('staff.index') }}">Staff</a> @elsecan('ADD STAFF') <a class="collapse-item" href="{{ route('staff.create') }}">Staff</a> @endcan
                @can('STOCK CATEGORY LIST') <a class="collapse-item" href="{{ route('stockcategory.index') }}">Stock Category</a> @elsecan('ADD STOCK CATEGORY') <a class="collapse-item" href="{{ route('stockcategory.create') }}">Stock Category</a> @endcan
                @can('UOMS LIST') <a class="collapse-item" href="{{ route('uom.index') }}">UOMs</a> @elsecan('ADD UOMS') <a class="collapse-item" href="{{ route('uom.create') }}">UOMs</a> @endcan
    ...
    <li class="nav-item">
        ...
        <div id="collapseUsersCog" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                @can('USER LIST') <a class="collapse-item" href="{{ route('user.index') }}">Users</a> @elsecan('ADD USER') <a class="collapse-item" href="{{ route('user.create') }}">Users</a> @endcan
