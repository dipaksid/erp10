...
Route::group(['middleware' => 'auth', 'middleware' => 'isAdmin'], function()
{
    ...
    Route::get('customergroup/customerlist', 'App\Http\Controllers\CustomerGroupsController@customerList')->name('customergroup.customerlist');
    Route::get('customergroup/categorylist', 'App\Http\Controllers\CustomerGroupsController@categorylist')->name('customergroup.categorylist');
    Route::get('customergroup/agentlist', 'App\Http\Controllers\CustomerGroupsController@agentlist')->name('customergroup.agentlist');
    Route::get('customergroup/custservice', 'App\Http\Controllers\CustomerGroupsController@custservice')->name('customergroup.custservice');
    Route::get('customergroup/printpdffile/{customergroup}', 'App\Http\Controllers\CustomerGroupsController@printpdffile')->name('customergroup.printpdffile');
    Route::post('customergroup/custservice', 'App\Http\Controllers\CustomerGroupsController@savecustservice')->name('customergroup.savecustservice');
    Route::post('customergroup/savegroupcustservice', 'App\Http\Controllers\CustomerGroupsController@savegroupcustservice')->name('customergroup.savegroupcustservice');
